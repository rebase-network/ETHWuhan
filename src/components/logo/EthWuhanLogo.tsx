  ...
  return (
    <svg viewBox="0 0 100 100" className={className} fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <g className="opacity-90">
        {/* Base Diamond */}
        <path d="M50 5L15 50L50 65L85 50L50 5Z" fill="currentColor" className="opacity-80" />
        <path d="M50 75L15 50L50 65L85 50L50 75Z" fill="currentColor" className="opacity-60" />
        ...
        <path d="M35 50Q50 45 65 50" stroke="currentColor" strokeWidth="1" className="opacity-90" />
        <path d="M30 65Q50 60 70 65" stroke="currentColor" strokeWidth="1" className="opacity-90" />
      </g>
